...
private:
    ...
    int XXXX_4;       // TODO: valor indefinido - usado em dois lugares: (1) FindBall2, margem
                      // somada a DangerArea (motor 20); (2) VerQueda, largura da zona intermediária
                      // somada a XXXX_3 (motor 19) — entre XXXX_3 e XXXX_3+XXXX_4 o goleiro agacha
                      // no meio em vez de mergulhar pra um lado
